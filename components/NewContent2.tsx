...
const NewContent2 = () => {
    return (
        <Card className='flex flex-col lg:flex-row w-full lg:w-[1300px] min-h-[500px] max-h-[1050px] overflow-hidden lg:h-[400px] bg-white mt-20 rounded-xl shadow-2xl shadow-slate-600 mx-auto animate-jump-in animate-once animate-duration-500 animate-delay-200 animate-ease-in-out '>
